...
class FullyConvolutionalNetworks(object):
    def __init__(self, input=None, use_placeholder=True, training_mode=True, img_size = 224, num_classes=151):
        ...
        self.__conv_t4_out = util.conv2d_transpose(self.__conv_t5_out_act, (3, 3), (25, 25), 64, 48, 1, name="dconv2",
                                                   do_summary=False)
        ...
        self.__conv_t3_out = util.conv2d_transpose(self.__conv_t4_out_act, (5, 5), (53, 53), 48, 36, 2, name="dconv3",
                                                   do_summary=False)
        ...
        self.__conv_t2_out = util.conv2d_transpose(self.__conv_t3_out_act, (5, 5), (110, 110), 36, 24, 2, name="dconv4",
                                                   do_summary=False)
        ...
        self.__conv_t1_out = util.conv2d_transpose(self.__conv_t2_out_act, (5, 5), (img_size, img_size), 24, num_classes, 2, name="dconv5",
                                                   do_summary=False)
